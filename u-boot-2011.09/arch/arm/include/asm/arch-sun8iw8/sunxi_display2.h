...
typedef struct
{
		int (*tv_enable)(unsigned int sel);
		int (*tv_disable)(unsigned int sel);
		int (*tv_suspend)(void);
		int (*tv_resume)(void);
		int (*tv_get_mode)(unsigned int sel);
		int (*tv_set_mode)(unsigned int sel, disp_tv_mode tv_mod);
		int (*tv_get_input_csc) (void);
		int (*tv_get_video_timing_info) (unsigned int sel, disp_video_timings **video_info);
		int (*tv_mode_support) (disp_tv_mode mode);
		int (*tv_get_dac_hpd)(unsigned int sel);
}disp_tv_func;
...
typedef struct
{
	...
	int (*mode_support)(unsigned int mode);
