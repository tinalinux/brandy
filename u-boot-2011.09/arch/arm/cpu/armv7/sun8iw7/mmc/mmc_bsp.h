/*
 * arch/arm/cpu/armv7/sun8iw7/mmc/mmc_bsp.h
 *
...
{
	__s32               card_ctrl_num;                //¡Á¨¹12¦Ì??¡§¦Ì???¨ºy
	__s32				boot_offset;                  //???¡§?¡§???¡¥??o¨®¡ê????-o¨ª??¨¤¨ª¡¤???¦Ì?1¨¹¨¤¨ª
	__s32 				card_no[4];                   //¦Ì¡À?¡ã???¡¥¦Ì??¡§o?, 16-31:GPIO¡À¨¤o?¡ê?0-15:¨º¦Ì?¨º?¡§?????¡Â¡À¨¤o?
	__s32 				speed_mode[4];                //?¡§¦Ì??¨´?¨¨?¡ê¨º?¡ê?0¡êo¦Ì¨ª?¨´¡ê????¨¹¡êo???¨´
	__s32				line_sel[4];                  //?¡§¦Ì?????¡ê?0: 1??¡ê????¨¹¡ê?4??
	__s32				line_count[4];                //?¡§¨º1¨®???¦Ì???¨ºy
	__s32  	        	sdc_2xmode[4];
	__s32				ddrmode[4];
	__s32               sdc_f_max[4]; 
