/*
 * arch/arm/cpu/armv7/sun8iw6/mmc/mmc_bsp.h
 *
...
{
	__s32               card_ctrl_num;                //?芍“112|足???∫|足???“oy
	__s32				boot_offset;                  //????∫??∫????ㄓ??o“??那????-o“a??“∟“a?∟???|足?1“1“∟“a
	__s32 				card_no[4];                   //|足?角???????ㄓ|足???∫o?, 16-31:GPIO?角“∟o??那?0-15:“o|足?“o??∫????????角“∟o?
	__s32 				speed_mode[4];                //??∫|足??“∩?““??那“o??那?0?那o|足“a?“∩?那????“1?那o???“∩
	__s32				line_sel[4];                  //??∫|足??????那?0: 1???那????“1?那?4??
	__s32				line_count[4];                //??∫“o1“????|足???“oy
	__s32  	        	sdc_2xmode[4];
	__s32				ddrmode[4];
	__s32               sdc_f_max[4]; 
