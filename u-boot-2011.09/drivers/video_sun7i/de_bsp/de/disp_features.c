/*
 * drivers/video_sun7i/de_bsp/de/disp_features.c
 *
...
static const int sun7iw1p1_disp_num_layers[] = {
	/* DISP_SCREEN0 */
	4,
};
...
static const __disp_output_type_t sun7iw1p1_disp_supported_output_types[] = {
	/* DISP_SCREEN0 */
	DISP_OUTPUT_TYPE_LCD | DISP_OUTPUT_TYPE_HDMI,
};
...
static const enum __disp_layer_feat sun7iw1p1_disp_layer_feats[] = {
	/* DISP_SCREEN0 */
	DISP_LAYER_FEAT_GLOBAL_ALPHA | DISP_LAYER_FEAT_POS |
	  DISP_LAYER_FEAT_PRE_MULT_ALPHA | DISP_LAYER_FEAT_PIXEL_ALPHA |
	  DISP_LAYER_FEAT_COLOR_KEY | DISP_LAYER_FEAT_ZORDER,
...
static const enum __disp_layer_feat sun7iw1p1_disp_scaler_layer_feats[] = {
	/* DISP_SCREEN0 */
	DISP_LAYER_FEAT_SCALE | DISP_LAYER_FEAT_COLOR_ENHANCE,
};
...
static const __disp_para_range sun7iw1p1_disp_layer_horizontal_resolution[] = {
  /* DISP_SCREEN0 */
  {0, 1366},
};

static const __disp_para_range sun7iw1p1_disp_layer_vertical_resolution[] = {
  /* DISP_SCREEN0 */
  {0, 768},
};

static const __disp_para_range sun7iw1p1_disp_scaler_horizontal_resolution[] = {
  /* DISP_SCREEN0 */
  {0, 8192},
};

static const __disp_para_range sun7iw1p1_disp_scaler_vertical_resolution[] = {
  /* DISP_SCREEN0 */
  {0, 8192},
};

static const int sun7iw1p1_disp_scaler_horizontal_resolution_in_out_limit[] = {
  /* DISP_SCREEN0 */
  1366,
};

static const int sun7iw1p1_disp_scaler_vertical_resolution_in_out_limit[] = {
  /* DISP_SCREEN0 */
  8192,
};
...
static const enum __disp_enhance_feat sun7iw1p1_disp_enhance_feats[] = {
  /* DISP_SCREEN0 */
  DISP_ENHANCE_BRIGHT | DISP_ENHANCE_SATURATION | DISP_ENHANCE_CONTRAST |
    DISP_ENHANCE_CONTRAST | DISP_ENHANCE_HUE |
    DISP_ENHANCE_WINDOW | DISP_ENHANCE_MODE,
...
static const int sun7iw1p1_disp_de_flicker_support[] = {
  /* DISP_SCREEN0 */
  0,
};
...
static const int sun7iw1p1_disp_smart_backlight_support[] = {
  /* DISP_SCREEN0 */
  1,
};
...
static const int sun7iw1p1_disp_image_detail_enhance_support[] = {
  /* DISP_SCREEN0 */
  0,
};

static const struct sunxi_disp_features sun8iw1p1_dss_features = {
	.num_screens = 2,
...
static const struct sunxi_disp_features sun8iw3p1_dss_features = {
	.num_screens = 1,
...
static const struct sunxi_disp_features sun7iw1p1_dss_features = {
	.num_screens = 1,
	.num_layers = sun7iw1p1_disp_num_layers,
	.num_scalers = 1,
	.layer_horizontal_resolution = sun7iw1p1_disp_layer_horizontal_resolution,
	.layer_vertical_resolution = sun7iw1p1_disp_layer_vertical_resolution,
	.scaler_horizontal_resolution = sun7iw1p1_disp_scaler_horizontal_resolution,
	.scaler_vertical_resolution = sun7iw1p1_disp_scaler_vertical_resolution,
	.scaler_horizontal_resolution_in_out_limit = sun7iw1p1_disp_scaler_horizontal_resolution_in_out_limit,
	.scaler_vertical_resolution_in_out_limit = sun7iw1p1_disp_scaler_vertical_resolution_in_out_limit,
	.num_wbs = 0,
	.supported_output_types = sun7iw1p1_disp_supported_output_types,
	//const enum sunxi_display_output_id *supported_outputs;
	//const enum sunxi_color_mode *supported_color_modes;
	.layer_feats = sun7iw1p1_disp_layer_feats,
	.scaler_layer_feats = sun7iw1p1_disp_scaler_layer_feats,
	.enhance_feats = sun7iw1p1_disp_enhance_feats,
	.de_flicker_support = sun7iw1p1_disp_de_flicker_support,
	.smart_backlight_support = sun7iw1p1_disp_smart_backlight_support,
	.image_detail_enhance_support = sun7iw1p1_disp_image_detail_enhance_support,
};
...
int bsp_disp_feat_init(void)
{
	...
	sunxi_disp_current_features = &sun8iw1p1_dss_features;
#elif (defined(CONFIG_ARCH_SUN8IW3P1) || defined(CONFIG_ARCH_SUN9IW1P1))
	sunxi_disp_current_features = &sun8iw3p1_dss_features;
#elif defined(CONFIG_ARCH_SUN7I) || (defined CONFIG_ARCH_SUN5I)
	sunxi_disp_current_features = &sun7iw1p1_dss_features;
#endif
	return 0;
}
