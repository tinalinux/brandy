/*
 * drivers/video_sunxi/sunxi_v1/de_bsp/bsp_display.h
 *
...
#define __debug(msg...)     do{if(bsp_disp_get_print_level()==2){printf(msg);}}while(0)
typedef unsigned int __hdle;
...
extern __s32 pwm_enable(__u32 channel);
extern __s32 pwm_disable(__u32 channel);
extern __s32 pwm_set_duty_ns(__u32 channel, __u32 duty_ns);
extern __s32 bsp_disp_lcd_set_panel_funs(char *drv_name, __lcd_panel_fun_t * lcd_cfg);
extern __s32 bsp_disp_lcd_get_panel_para(__u32 screen_id, __panel_para_t * info);
extern __s32 bsp_disp_lcd_iic_write(__u8 slave_addr, __u8 sub_addr, __u8 value);
extern __s32 bsp_disp_lcd_iic_read(__u8 slave_addr, __u8 sub_addr, __u8* value);
