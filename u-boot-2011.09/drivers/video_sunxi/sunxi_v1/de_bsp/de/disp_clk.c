/*
 * drivers/video_sunxi/sunxi_v1/de_bsp/de/disp_clk.c
 *
...
__s32 disp_clk_cfg(__u32 screen_id, __u32 type, __u8 mode)
{
	...
	if(type == DISP_OUTPUT_TYPE_TV || type == DISP_OUTPUT_TYPE_HDMI) {
		...
		pre_scale = 1;
#if defined (CONFIG_A50_FPGA) || defined (CONFIG_A67_FPGA) || defined (CONFIG_A73_FPGA) || defined(CONFIG_A81_FPGA)||defined(CONFIG_A80_FPGA)
