/*
 * drivers/video_sunxi/sunxi_v1/de_bsp/de/disp_video.c
 *
...
//		__u32 size;
		...
		DE_SCAL_Set_Di_MafFlag_Src(scaler_index, g_video[screen_id][id].cur_maf_flag_addr, g_video[screen_id][id].pre_maf_flag_addr, maf_linestride);
