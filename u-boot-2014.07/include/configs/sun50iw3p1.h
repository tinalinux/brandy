...
#define CONFIG_TARGET_NAME      sun50iw3p1
...
#define CONFIG_BOOT0_STACK_BOTTOM        (CONFIG_SYS_SRAM_BASE  + CONFIG_SYS_SRAM_SIZE)
...
//sramc 0x28000~0x48fff
#define CONFIG_BOOT0_CPU1_STACK_BOTTOM   0x48000
...
#define CONFIG_TOC0_RUN_ADDR             (0x20480)
