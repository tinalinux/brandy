...
#define AW_IRQ_NAND                    (63)
#define AW_IRQ_USB_OTG                 (107)	/*USB2.0_DRD_DEVICE*/
#define AW_IRQ_USB_EHCI0               (108)
#define AW_IRQ_USB_OHCI0               (109)
#define AW_IRQ_DMA                     (42)
#define AW_IRQ_TIMER0                  (101)
#define AW_IRQ_TIMER1                  (102)
#define AW_IRQ_NMI                     (160)
#define GIC_IRQ_NUM                    (230)
