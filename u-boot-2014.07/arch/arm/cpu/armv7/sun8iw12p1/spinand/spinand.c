...
//	SPINAND_Print("SPN_BLOCK_SIZE %d\n",SPN_BLOCK_SIZE);
//	SPINAND_Print("SPN_PAGE_SIZE %d\n",SPN_PAGE_SIZE);
	switch( SPN_BLOCK_SIZE )
	{
		case SZ_128K :
			SPN_BLK_SZ_WIDTH = 17;
			blk_for_boot1	=  BLKS_FOR_BOOT1_IN_128K_BLK;
			break;
		case SZ_256K :
			SPN_BLK_SZ_WIDTH = 18;
			blk_for_boot1	=  BLKS_FOR_BOOT1_IN_256K_BLK;
			break;
		case SZ_512K :
			SPN_BLK_SZ_WIDTH = 19;
			blk_for_boot1	=  BLKS_FOR_BOOT1_IN_512K_BLK;
			break;
		case SZ_1M :
			SPN_BLK_SZ_WIDTH = 20;
			blk_for_boot1	=  BLKS_FOR_BOOT1_IN_1M_BLK;
			break;
		case SZ_2M :
			SPN_BLK_SZ_WIDTH = 21;
			blk_for_boot1	=  BLKS_FOR_BOOT1_IN_2M_BLK;
			break;
		case SZ_4M :
			SPN_BLK_SZ_WIDTH = 22;
			blk_for_boot1	=  BLKS_FOR_BOOT1_IN_4M_BLK;
			break;
		case SZ_8M :
			SPN_BLK_SZ_WIDTH = 23;
			blk_for_boot1	=  BLKS_FOR_BOOT1_IN_8M_BLK;
			break;
		default :
		{
			SPINAND_Print("GET BLOCK_SIZE FAIL\n");
			goto error;
		}
	}
	UBOOT_LAST_BLK_NUM = BOOT1_START_BLK_NUM + blk_for_boot1 - 1;
	SPINAND_Print("spinand UBOOT_LAST_BLK_NUM %d\n",UBOOT_LAST_BLK_NUM);
