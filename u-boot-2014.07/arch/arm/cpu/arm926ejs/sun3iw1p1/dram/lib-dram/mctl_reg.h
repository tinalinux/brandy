...
#define SDR _T_CAS                       0x2  // CL
#define SDR _T_RAS                       0x8  // 120000ns>=tRAS>=42ns SDR166
#define SDR _T_RCD                       0x2  // tRCD>=15ns           SDR166
#define SDR _T_RP                        0x2  // tRP>=15ns            SDR166
#define SDR _T_WR                        0x2  // tRP>=12ns            SDR166
#define SDR _T_RFC                       0xd  // tRFC>=60ns           SDR166
#define SDR _T_XSR                       0xf9 // tXSRD>=200CK
#define SDR _T_RC                        0xa  // tRC>=60ns            SDR166
#define SDR _T_INIT                      0x8  //
#define SDR _T_INIT_REF                  0x7
#define SDR _T_WTR                       0x1  // tWTR>=2CK            SDR166
#define SDR _T_RRD                       0x1  // tRRD>=12ns           SDR166
#define SDR _T_XP                        0x0  // one clk is ok
