...
ifneq  ("$(src)", "")
    ...
    tooldir_armv5=$(src)/../armv5_toolchain
    toolchain_archive_armv5=$(src)/../toolchain/arm-none-linux-gnueabi-toolchain.tar.xz
    ...
    CROSS_COMPILE :=  $(src)/../armv5_toolchain/arm-none-linux-gnueabi-toolchain/arm-2014.05/bin/arm-none-linux-gnueabi-
endif
